...
Here is how each allele contribute to the axes while displaying only the names of the top 5 most frequent private alleles:
```{r contribution to dimension}
s.arrow(mypca$co[, 1:2], boxes = FALSE, cpoint = 0, clabel = 0)
private_alleles_highfreq <- private_alleles_freq(myData)$Private_allele[1:5]
s.arrow(mypca$co[private_alleles_highfreq, 1:2], boxes = FALSE, clabel = 0.8, add.plot = TRUE)
```
